...
import { BookOpen, Users, FileText, Bell, ArrowRight, Check, Smartphone, Clock, Shield, Mail, Phone, MapPin } from 'lucide-react';
...
export function meta() {
	return [
		...
		{ name: "description", content: "De moderne elektronische leeromgeving voor middelbare scholieren. Toegang tot al je vakken, mededelingen en bestanden op één plek." },
	];
}
			...
			<section className="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 text-white">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
					<div className="text-center">
						...
						<p className="text-xl md:text-2xl text-primary-100 mb-8 max-w-8xl mx-auto">
							De moderne <strong>Elektronische Leeromgeving</strong> voor middelbare scholieren.
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center">
							{user ? (
								...
								<>
									...
									<Link to="/login">
										<Button size="lg" variant="outline" className="text-lg border-white text-primary-400 hover:bg-white hover:text-primary-700">
											Inloggen
										</Button>
									</Link>
								</>
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-neutral-600 max-w-8xl mx-auto">
							Een Elektronische Leeromgeving (ELO) is een digitaal platform dat het leren en onderwijzen ondersteunt.
							Het biedt een centrale plek waar leerlingen en docenten kunnen communiceren, materialen delen en leervoortgang bijhouden.
						</p>
					</div>
			...
			<section className="py-20 bg-neutral-50">
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
					<div className="text-center mb-16">
						...
						<p className="text-lg text-neutral-600 max-w-8xl mx-auto">
							Onze ELO is speciaal ontworpen voor middelbare scholieren en biedt alle tools die je nodig hebt voor succesvol leren.
						</p>
					</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
						<div className="space-y-8">
							<div className="flex items-start space-x-4">
								...
								<div>
									<h3 className="text-xl font-semibold mb-2 text-neutral-900">Gebruiksvriendelijk Design</h3>
									<p className="text-neutral-600">
										Intuïtieve interface die gemakkelijk te navigeren is, zelfs voor nieuwe gebruikers.
									</p>
								</div>
							</div>
							...
							<div className="flex items-start space-x-4">
								...
								<div>
									<h3 className="text-xl font-semibold mb-2 text-neutral-900">Mobiel Vriendelijk</h3>
									<p className="text-neutral-600">
							...
							<div className="flex items-start space-x-4">
								...
								<div>
									<h3 className="text-xl font-semibold mb-2 text-neutral-900">Veilig & Betrouwbaar</h3>
									<p className="text-neutral-600">
										Je gegevens zijn veilig met moderne beveiligingstechnologieën en privacy-bescherming.
									</p>
								</div>
							</div>
